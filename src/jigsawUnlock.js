...
const JigsawUnlock = () => {
  ...
  return (
    <div className="main">
      <img ref={imgRef} src={defaultImg} className="img" alt="" />
      <canvas
        ref={pieceOfPuzzle}
        className="piece"
      ...
      <div className="sliderWrap">
        slide to unlock
        <div className="progress" style={{ width: sliderX }} />
        <div
          className={`arrow ${
            result !== null ? (result ? "arrow--success" : "arrow--failed") : ""
          }`}
          style={{ left: sliderX }}
